...
def snicdemo(base_path, img_name, numspixels, compactness):
#--------------------------------------------------------------
# Set parameters and call the C function
#--------------------------------------------------------------
    numsuperpixels = numspixels
...
if __name__ == "__main__":
		...
		dict_superpixels = {16000:18}

		for spixels in dict_superpixels.items():
				for file in tqdm(files):
					snicdemo(base_path, file, spixels[0], spixels[1])
				os.rename('timingHD.log', f'timingHD_{spixels[0]}.log')
